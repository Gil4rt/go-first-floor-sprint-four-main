...
func RunningSpentCalories(action int, weight, duration float64) float64 {
	// ваш код здесь
	return runningCaloriesMeanSpeedShift + (meanSpeed(action, duration) * runningCaloriesMeanSpeedMultiplier * weight)
}
...
func WalkingSpentCalories(action int, duration, weight, height float64) float64 {
	// ваш код здесь
	return (walkingCaloriesWeightMultiplier * weight * float64(action)) + (walkingSpeedHeightMultiplier * meanSpeed(action, duration) * height)
}
...
func SwimmingSpentCalories(lenghtPool, countPool int, duration, weight float64) float64 {
	// ваш код здесь
	return (swimmingCaloriesMeanSpeedShift * swimmingMeanSpeed(lenghtPool, countPool, duration) * weight) + (swimmingCaloriesWeightMultiplier * weight)
}
